...
export const categories: EventCategory[] = [
  { id: "wedding", name: "Wedding", image: catWedding, description: "Timeless ceremonies crafted with elegance and love. From intimate garden weddings to grand ballroom celebrations, we bring your dream day to life with meticulous attention to every detail.", icon: "💍", gallery: [catWedding, catEngagement, catReception, catCoupleEntry] },
  { id: "birthday", name: "Birthday", image: catBirthday, description: "Milestone celebrations made extraordinary. Whether it's a first birthday or a golden jubilee, we design memorable experiences tailored to your vision.", icon: "🎂", gallery: [catBirthday, catCakes, catGaming, catSurprise] },
  ...
  { id: "reception", name: "Reception", image: catReception, description: "Grand receptions that leave lasting impressions. Stunning décor, exquisite dining, and seamless coordination for your special evening.", icon: "🥂", gallery: [catReception, catCatering, catCoupleEntry, catWedding] },
  ...
  { id: "cakes", name: "Cakes", image: catCakes, description: "Stunning confections that are works of art. Custom-designed cakes that are as beautiful as they are delicious.", icon: "🎂", gallery: [catCakes, catCatering, catBirthday, catSurprise] },
